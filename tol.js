...
MBob_config.innerHTML = '<center><input id="MBob_nazpotwor" placeholder="Nazwy potworów" value="Szkielet rycerza, Szkielet łucznika, Szkarłatny rycerz, Szkielet hieny olbrzymiej">';
