...
MBob_config.innerHTML = '<center><input id="MBob_nazpotwor" placeholder="Nazwy potworów" value="Góralski rozbójnik, Mistrz ciupagi, Łowca fretek, Strażnik piwa, Hanka patelnianka, Dobra żona, Stary dziad">';
