...
MBob_config.innerHTML = '<center><input id="MBob_nazpotwor" placeholder="Nazwy potworów" value="Hydra turkusowa, Hydra bagienna, Hydra piaskowa, Zurlorog, Hydra ognista, Barimnog, Hydra kamienna">';
