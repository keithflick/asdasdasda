...
MBob_config.innerHTML = '<center><input id="MBob_nazpotwor" placeholder="Nazwy potworów" value="Zły magazynier, Wkurzony magazynier, Nieuprzejmy magazynier, Niemiły magazynier, Złośliwy magazynier, Zdenerwowany magazynier, Podły magazynier">';
