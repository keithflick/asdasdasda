...
MBob_config.innerHTML = '<center><input id="MBob_nazpotwor" placeholder="Nazwy potworów" value="Mnich chybione zaklęcie, Duchowy rozpruwacz, Śmierć magazyniera, Przerażający mnich">';
