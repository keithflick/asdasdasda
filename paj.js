...
MBob_config.innerHTML = '<center><input id="MBob_nazpotwor" placeholder="Nazwy potworów" value="Harpia, Grzechotnik, Czarny orzeł, Kobra, Orzeł górski, Zgniła galareta, Wodna galareta, Trująca galareta">';
